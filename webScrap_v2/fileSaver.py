...
class FSaver:
    ...
    def get_saver(self, save_extention='pickle'):
...
class JsonSaver:
    ...
    def save_file(self, data:any, file_name:str, save_extention) -> None:
        save_path = self.filePath.joinpath(f'{file_name}.{save_extention}')
